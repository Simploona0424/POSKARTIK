...
function Invoice() {
    ...
    const handleCloseTable = async () => {
        ...
        try {
            await axios.post(`https://poskartik.onrender.com/api/savedCustomer`, { ...currentCustomer, currentDate });
            await axios.delete(`https://poskartik.onrender.com/api/DeleteCurrentCustomer/${id}`);
